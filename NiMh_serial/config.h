...
#define LOG_ENABLE      (1)
// Comment out next line to enable casual mode, not sensor test one
//#define SENSOR_TEST     (1)

// Comment out next line to disable twisting the display lines
// If the line enabled, 0-th channel will be shown on bottom line of the display
//#define TWIST_DISPLAY   (1)
